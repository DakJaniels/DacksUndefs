...
---@type ESOUSERDATATYPE
    ...
    ---@param _Message string The message text.
    ---@param _Red number (optional) The red color component.
    ---@param _Green number (optional) The green color component.
    ---@param _Blue number (optional) The blue color component.
    ...
    --- Changes the window fade settings.
    ---@param _FadeDelay number The fade delay for the window.
    ---@param _FadeTime number The fade time for the window.
    ...
    --- Changes the text fade settings.
    ---@param _FadeDelay number The fade delay for the text lines.
    ---@param _FadeTime number The fade time for the text lines.
